...
class bilibili():
    ...
    def silver2coin(self):
        ...
        temp_params = 'access_key=' + self.dic_bilibili['access_key'] + '&actionKey=' + self.dic_bilibili['actionKey'] + '&appkey=' + self.dic_bilibili['appkey'] + '&build=' + self.dic_bilibili['build'] + '&device=' + self.dic_bilibili['device'] + '&mobi_app=' + self.dic_bilibili['mobi_app'] + '&platform=' + self.dic_bilibili['platform'] + '&ts=' + CurrentTime()
    ...
    def send_danmu_msg_andriod(self, msg, roomId):
        ...
        # page ??
        time = CurrentTime()
        list_url = ["access_key=" + self.dic_bilibili['access_key'], "appkey=" + self.dic_bilibili['appkey'],  'aid=', 'page=1', "build=" + self.dic_bilibili['build']]
    ...
    def login(self):
        ...
        if username != "":
            ...
            payload = "appkey=" + self.dic_bilibili['appkey'] + "&password=" + password + "&username=" + username + "&sign=" + sign
    ...
    def get_gift_of_events(self, text1, text2, raffleid):
        ...
        temp_params = 'access_key=' + self.dic_bilibili['access_key'] + '&actionKey=' + self.dic_bilibili['actionKey'] + '&appkey=' + self.dic_bilibili['appkey'] + '&build=' + self.dic_bilibili['build'] + '&device=' + self.dic_bilibili['device'] + '&event_type=flower_rain-' + str(
                        raffleid) + '&mobi_app=' + self.dic_bilibili['mobi_app'] + '&platform=' + self.dic_bilibili['platform'] + '&room_id=' + str(
    ...
    def get_gift_of_TV(self, real_roomid, raffleid):
        temp_params = 'access_key=' + self.dic_bilibili['access_key'] + '&actionKey=' + self.dic_bilibili['actionKey'] + '&appkey=' + self.dic_bilibili['appkey'] + '&build=' + self.dic_bilibili['build'] + '&device=' + self.dic_bilibili['device'] + '&id=' + str(
            raffleid) + '&mobi_app=' + self.dic_bilibili['mobi_app'] + '&platform=' + self.dic_bilibili['platform'] + '&roomid=' + str(
    ...
    def get_giftlist_of_TV(self, real_roomid):
        temp_params = 'access_key=' + self.dic_bilibili['access_key'] + '&actionKey=' + self.dic_bilibili['actionKey'] + '&appkey=' + self.dic_bilibili['appkey'] + '&build=' + self.dic_bilibili['build'] + '&device=' + self.dic_bilibili['device'] + \
                                  '&mobi_app=' + self.dic_bilibili['mobi_app'] + '&platform=' + self.dic_bilibili['platform'] + '&roomid=' + str(
                        real_roomid) + '&ts=' + CurrentTime()
        params = temp_params + self.dic_bilibili['app_secret']
        hash = hashlib.md5()
        hash.update(params.encode('utf-8'))
    ...
    def get_activity_result(self, activity_roomid, activity_raffleid):
        url = "http://api.live.bilibili.com/activity/v1/Raffle/notice?roomid="+str(activity_roomid)+"&raffleId="+str(activity_raffleid)
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36',
            'Accept-Language': 'zh-CN,zh;q=0.9',
    ...
    def get_TV_result(self, TV_roomid, TV_raffleid):
        url="http://api.live.bilibili.com/gift/v2/smalltv/notice?roomid="+str(TV_roomid)+"&raffleId="+str(TV_raffleid)
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36',
            'Accept-Language': 'zh-CN,zh;q=0.9',
        ...
        if self.activity_raffleid_list:               
            for i in range(0,len(self.activity_roomid_list)):
                ...
                if json_response['code'] == 0:
                    ...
                    print("# 房间", str(self.activity_roomid_list[0]).center(9), "网页端活动抽奖结果:", data['gift_name']+"x"+str(data['gift_num']))
        ...
        if self.TV_raffleid_list:
            for i in range(0, len(self.TV_roomid_list)):
                ...
                if json_response['data']['gift_id'] == '-1':
                    ...
                    data = json_response['data']
                    print("# 房间", str(self.TV_roomid_list[0]).center(9), "小电视道具抽奖结果:", data['gift_name'] +"x"+str(data['gift_num']))
    ...
    def apppost_heartbeat(self):
        time = CurrentTime()
        temp_params = 'access_key=' + self.dic_bilibili['access_key'] + '&actionKey=' + self.dic_bilibili['actionKey'] + '&appkey=' + self.dic_bilibili['appkey'] + '&build=' + self.dic_bilibili['build'] + '&device=' + self.dic_bilibili['device'] + '&mobi_app=' + self.dic_bilibili['mobi_app'] + '&platform=' + self.dic_bilibili['platform'] + '&ts=' + time
        params = temp_params + self.dic_bilibili['app_secret']
        hash = hashlib.md5()
        hash.update(params.encode('utf-8'))
    ...
    def assign_group(self, i1, i2):
        temp_params = "_device="+self.dic_bilibili['device']+"&_hwid=SX1NL0wuHCsaKRt4BHhIfRguTXxOfj5WN1BkBTdLfhstTn9NfUouFiUV&access_key="+self.dic_bilibili['access_key']+"&appkey="+self.dic_bilibili['appkey']+"&build="+self.dic_bilibili['build']+"&group_id="+str(i1)+"&mobi_app="+self.dic_bilibili['mobi_app']+"&owner_id="+str(i2)+"&platform="+self.dic_bilibili['platform']+"&src=xiaomi&trace_id=20171224024300024&ts="+CurrentTime()+"&version=5.20.1.520001"
        params = temp_params + self.dic_bilibili['app_secret']
        hash = hashlib.md5()
        hash.update(params.encode('utf-8'))
